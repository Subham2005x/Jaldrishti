...
class MyReportsWidget extends StatefulWidget {
  ...
  static String routeName = 'MyReports';
  static String routePath = '/myReports';
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        '6biqgsxf' /* Below are Your Uploded Previou... */,
                      ),
                        ...
                        StreamBuilder<List<ReportsRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<ReportsRecord> listViewReportsRecordList =
                                snapshot.data!;
                            if (listViewReportsRecordList.isEmpty) {
                  ...
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'gid0iqpg' /* Saved Offline Reports :  */,
                      ),
                      textAlign: TextAlign.start,
                      style: FlutterFlowTheme.of(context).labelMedium.override(
                            font: GoogleFonts.inter(
